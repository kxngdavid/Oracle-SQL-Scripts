...
rem -> In this session, we've gone through how to use and understand the Rank() window function in SQL. 
rem-> We'd explore some more functions in other sessions. Thank You!
